            ...
            <div className="bg-white rounded-xl shadow-md p-8 h-full">
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a
                    href="https://github.com/KeRusty"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-secondary-200 hover:bg-primary-600 hover:text-white text-secondary-700 p-3 rounded-full transition-colors"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="currentColor"
                  ...
                  <a
                    href="https://www.linkedin.com/in/chathu-abeywickrama/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-secondary-200 hover:bg-primary-600 hover:text-white text-secondary-700 p-3 rounded-full transition-colors"
                  >
